...
build do
  command "if [ ! -d flapjack_source ] ; then git clone https://github.com/masteinhauser/flapjack.git flapjack_source ; fi"
  ...
  command "/opt/flapjack/embedded/bin/gem install " \
        "/var/cache/omnibus/src/flapjack/flapjack/flapjack_source/flapjack*gem " \
